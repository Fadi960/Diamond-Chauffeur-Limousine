...
/**
 * Blog6 component displaying a blog post with image, metadata, and content.
 */
const Blog6 = () => {
  return (
    <div className="bg-white py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-4">
          The safest airline companies in the world spend 5 million a year to repair aircraft
        </h2>
