...
/**
 * Blog3 component displaying a blog post with image, metadata, and content.
 */
const Blog3 = () => {
  return (
    <div className="bg-white py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center text-gray-500 text-sm mb-4">
          <div className="bg-yellow-400 text-white rounded-full px-4 py-4 text-center">
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-4">
          Irish low-cost airline announced regular flights to the Emirates
        </h2>
